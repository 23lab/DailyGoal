...
public class SatelliteMenu extends FrameLayout {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		if (attrs != null) {
			...
			satelliteDistance = typedArray.getDimensionPixelSize(
			...
			closeItemsOnClick = typedArray.getBoolean(R.styleable.SatelliteMenu_closeOnClick,
	...
	public void addItems(List<SatelliteMenuItem> items) {
		...
		for (SatelliteMenuItem menuItem : menuItems) {
			...
			layoutParams.rightMargin = finalX;
			layoutParams.bottomMargin = finalY;
			cloneView.setLayoutParams(layoutParams);
			cloneView.setBackgroundColor(color.background_dark);
	...
	/**
	 * Defines the algorithm to define the gap between each item. Note: Calling before adding items
	...
	/**
	 * Defines the total space between the initial and final item in degrees. Note: Calling before
	 * adding items is strongly recommended.
	 * 
	...
	/**
	 * Sets the distance of items from the center in pixels. Note: Calling before adding items is
	...
	/**
	 * Sets the duration for expanding and collapsing the items in miliseconds. Note: Calling before
	 * adding items is strongly recommended.
	 * 
	 * @param expandDuration
	 *            the duration for expanding and collapsing the items in miliseconds.
	 */
