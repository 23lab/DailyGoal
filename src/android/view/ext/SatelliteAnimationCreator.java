...
public class SatelliteAnimationCreator {
	...
	public static Animation createItemInAnimation(Context context, int index,
		...
		TranslateAnimation translate = new TranslateAnimation(x * -1, 0, y * -1, 0);
	...
	public static Animation createItemOutAnimation(Context context, int index,
		...
		TranslateAnimation translate = new TranslateAnimation(0, x * -1, 0, y * -1);
	...
	public static int getTranslateX(float degree, int distance) {
		return Double.valueOf(distance * Math.sin(Math.toRadians(degree)))
				.intValue();
	}
